...
/*
 * NS-3 Standalone Simulation: Test Case 8 (MTU Stress / High Interference)
 * Parameters: 55 Nodes, 1024B Packets, 7.0 m/s Speed, 0.70 Threat Threshold.
 */
...
NS_LOG_COMPONENT_DEFINE ("QRA_IoT_TestCase8");

uint32_t g_processedPackets = 0;
double g_threatThreshold = 0.70; // High security drop rate (30%)
...
{
    // ==========================================
    // 1. PARAMETERS FOR TEST CASE 8
    // ==========================================
    uint32_t numNodes = 55;
    uint32_t packetSize = 1024; // Large MTU Stress
    double maxSpeed = 7.0;      // Fast industrial mobility
    ...
    LogComponentEnable ("QRA_IoT_TestCase8", LOG_LEVEL_INFO);
    ...
    // Calculations for Result Params
    ...
    // ==========================================
    std::cout << "\n================================================================\n";
    std::cout << " TEST CASE 8: MTU Stress / High Interference (55 Nodes, 7.0 m/s)\n";
    std::cout << "================================================================\n";
