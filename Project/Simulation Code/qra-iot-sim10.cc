...
/*
 * NS-3 Standalone Simulation: Test Case 10 (Extreme MANET Conditions)
 * Parameters: 65 Nodes, 256B Packets, 10.0 m/s Speed, 0.90 Threat Threshold.
 */
...
NS_LOG_COMPONENT_DEFINE ("QRA_IoT_TestCase10");
...
{
    // ==========================================
    // 1. PARAMETERS FOR TEST CASE 10 (EXTREME)
    // ==========================================
    uint32_t numNodes = 65;    // Maximum density
    uint32_t packetSize = 256;
    double maxSpeed = 10.0;    // High-speed robotic movement
    ...
    LogComponentEnable ("QRA_IoT_TestCase10", LOG_LEVEL_INFO);
    ...
    // ==========================================
    // 5. APPLICATIONS (Stress Traffic Flow)
    // ==========================================
    uint16_t port = 9;
    ...
    // Mathematical calculations for Result Params
    ...
    // ==========================================
    std::cout << "\n================================================================\n";
    std::cout << " TEST CASE 10: Extreme Conditions (65 Nodes, 10.0 m/s Speed)\n";
    std::cout << "================================================================\n";
