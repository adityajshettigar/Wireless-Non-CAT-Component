...
/*
 * NS-3 Standalone Simulation: Test Case 5 (Heavy Payload / Video Telemetry)
 * Parameters: 40 Nodes, 512B Packets, 5.0 m/s Speed, 0.85 Threat Threshold.
 */
...
NS_LOG_COMPONENT_DEFINE ("QRA_IoT_TestCase5");
...
{
    // ==========================================
    // 1. PARAMETERS FOR TEST CASE 5
    // ==========================================
    uint32_t numNodes = 40;
    uint32_t packetSize = 512; // Increased payload size
    double maxSpeed = 5.0;     // Standard robotic movement speed
    ...
    LogComponentEnable ("QRA_IoT_TestCase5", LOG_LEVEL_INFO);
    ...
    // ==========================================
    // 5. APPLICATIONS (Heavy Payload Flow)
    // ==========================================
    uint16_t port = 9;
    ...
    // ==========================================
    std::cout << "\n================================================================\n";
    std::cout << " TEST CASE 5: Heavy Payload Telemetry (40 Nodes, 512B Pkts)\n";
    std::cout << "================================================================\n";
