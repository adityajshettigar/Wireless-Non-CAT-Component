...
/*
 * NS-3 Standalone Simulation: Test Case 1 (Light Network / Low Mobility)
 * Parameters: 20 Nodes, 64B Packets, 1.0 m/s Speed, 0.95 Threat Threshold.
 */
...
NS_LOG_COMPONENT_DEFINE ("QRA_IoT_TestCase1");

uint32_t g_processedPackets = 0;
double g_threatThreshold = 0.95;
...
int main (int argc, char *argv[])
{
    ...
    LogComponentEnable ("QRA_IoT_TestCase1", LOG_LEVEL_INFO);
    ...
    // ==========================================
    std::cout << "\n================================================================\n";
    std::cout << " TEST CASE 1: Light Network / Low Mobility (20 Nodes, 1.0 m/s)\n";
    std::cout << "================================================================\n";
