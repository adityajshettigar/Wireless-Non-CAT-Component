...
/*
 * NS-3 Standalone Simulation: Test Case 9 (Dense Network Congestion)
 * Parameters: 60 Nodes, 1024B Packets, 8.0 m/s Speed, 0.85 Threat Threshold.
 */
...
NS_LOG_COMPONENT_DEFINE ("QRA_IoT_TestCase9");
...
{
    // ==========================================
    // 1. PARAMETERS FOR TEST CASE 9 (CONGESTION)
    // ==========================================
    uint32_t numNodes = 60;
    uint32_t packetSize = 1024;
    double maxSpeed = 8.0;      // High speed mobility
    ...
    LogComponentEnable ("QRA_IoT_TestCase9", LOG_LEVEL_INFO);
    ...
    // ==========================================
    std::cout << "\n================================================================\n";
    std::cout << " TEST CASE 9: Dense Network Congestion (60 Nodes, 8.0 m/s)\n";
    std::cout << "================================================================\n";
